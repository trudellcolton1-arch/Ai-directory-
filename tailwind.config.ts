...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Bold, distinctive palette - dark mode first
        brand: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, rgba(34, 197, 94, 0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(34, 211, 238, 0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, rgba(163, 230, 53, 0.1) 0px, transparent 50%)',
